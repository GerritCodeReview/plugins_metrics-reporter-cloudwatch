...
class GerritCloudwatchReporterConfig {
    ...
    private static final String SECTION_CLOUDWATCH = "cloudwatch";

    private static final String KEY_NAMESPACE = "namespace";
    private static final String KEY_RATE = "rate";
    private static final String KEY_INITIAL_DELAY = "initialDelay";

    private static final String DEFAULT_NAMESPACE = "gerrit";
    private static final Integer DEFAULT_RATE_SECS = 60;
    private static final Integer DEFAULT_INITIAL_DELAY_SECS = 0;
